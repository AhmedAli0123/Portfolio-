                ...
                <div className="mt-12 flex flex-col justify-center text-center items-center">
                    ...
                    <ul className="mt-4 mr-7 relative right-5">
                        <li className="flex items-center justify-center">
                            ...
                            <a href="Mailto:ahmedsiridab1@gmail.com" className="text-sm ml-4">
                                <small className="block">Mail</small>
                                <strong className='font-bold hover:underline'>ahmedsiridab1@gmail.com</strong>
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <div className="mt-12">
                    ...
                    <ul className="flex mt-4 space-x-4 justify-center">
                        <li className="bg-[#e6e6e6cf]  hover:bg-gray-500 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                            <a href="https://www.facebook.com/people/Ahmed-Aly/pfbid0341k7GFeyygf2G89P7wdGqAM9aha1P4qu4CMtA92aPGEvy47WCfB1kC8QG5CJ6kDcl/" target='blank' 
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="25px" fill='#007bff'
                        ...
                        <li className="bg-[#e6e6e6cf] hover:bg-gray-500 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                            <a href="https://www.linkedin.com/in/ahmed-ali-160b2a313/" target='blank'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="25px" fill='#007bff' className='hover:text-gray-500'
                                    viewBox="0 0 511 512">
                                    <path
                        ...
                        <li className="bg-[#e6e6e6cf] hover:bg-gray-500 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                            <a href="https://www.instagram.com/yours._.ahmed._/?next=%2F" target='blank'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="25px" fill='#007bff'
                                    viewBox="0 0 24 24">
                                    <path
