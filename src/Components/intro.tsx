...
const Intro: React.FC = () => {
  ...
  return (
     ...
     data-aos-anchor-placement="top-bottom"
                  ...
                  height={300}
                  width={300}
                  className='shadow-2xl rounded-full mt-10 '
                />
              </div>
              ...
              <div  className=' md:ml-20 sm:ml-12 md:w-1/2'>
                ...
                <h1 className='text-7xl uppercase hidden md:block text-pink-700 font-bold' data-aos="fade-right">Full Stack Developer</h1>
                <h1 className='text-2xl mt-5 md:text-3xl'>
                  Hello, I&#39;m <span className='text-pink-700 text-3xl uppercase md:text-4xl' >{userInfo.name}</span>
                  </h1>
                  ...
                  <button className='w-28 h-10 bg-pink-700 text-white rounded-md hover:bg-pink-800' onClick={handleShowResume}>View Resume</button>
